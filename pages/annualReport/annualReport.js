...
Page({
  ...
  download() {
    var that = this
    wx.downloadFile({
      url: 'http://172.16.30.60:3000/api/downloadAnnualReportTemplate', 
  ...
  */
  downloadAndSaveFile() {
    // downloadAndOpenDocument('/api/downloadAnnualReportTemplate')
    downloadAndOpenDocument('/file/annualReportTemplate.docx')
  },
