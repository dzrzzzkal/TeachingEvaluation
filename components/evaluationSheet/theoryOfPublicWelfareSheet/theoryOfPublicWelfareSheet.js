// components/evaluationSheet/theoryOfPublicWelfareSheet/theoryOfPublicWelfareSheet.js
...
Component({
  ...
  data: {
    ...
    rules: [
      ...
      {
        name: 'theoryOfPublicWelfareEvaluation',
  ...
  methods: {
    ...
    // 点击提交按钮
    submitForm() {
      dealAndSubmitForm(this, 'theoryOfPublicWelfareEvaluation')
    },
  },
